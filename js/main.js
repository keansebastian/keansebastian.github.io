...
(function(html) {
    ...
    * ---------------------------------------------------- */
    const ssMobileMenu = function() {
        ...
        document.addEventListener('click', function(event) {
            if (!mainNavWrap.contains(event.target) && !toggleButton.contains(event.target)) {
                closeMenu();
            }
        });
    
        // Close the menu when the window is resized above 800px
    ...
    * ------------------------------------------------------ */
    const ssScrollSpy = function() {
        ...
        function navHighlight() {
            ...
            // If at the bottom of the page, remove all highlights
            if (scrollY + window.innerHeight === documentHeight) {
                document.querySelectorAll('.main-nav li.current').forEach(function(el) {
    ...
    * ------------------------------------------------------ */
    ...
    } else if (carousel.scrollLeft + carouselWrapper.offsetWidth >= carousel.scrollWidth) {
